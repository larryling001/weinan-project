<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableList" border size="mini" @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    handleGenTable(row) {
      ...
      downLoadZip("/tool/gen/batchGenCode?tables=" + tableNames, "iking");
    },
    /** 打开导入表弹窗 */
    openImportTable() {
