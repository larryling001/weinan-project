<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="menuList" border size="mini" row-key="menuId" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" >
      ...
      <el-table-column prop="perms" label="权限标识" width="200px" :show-overflow-tooltip="true"></el-table-column>
